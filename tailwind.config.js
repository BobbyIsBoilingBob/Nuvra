...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        ink: { 50:'#f0f4ff',100:'#e0e9ff',200:'#c7d6fe',300:'#a4b8fc',400:'#8094f8',500:'#6568f0',600:'#5250e0',700:'#4340c7',800:'#3836a1',900:'#312f81',950:'#1e1c4d' },
        ...
        surface: { 0:'#f8fafc',50:'#f1f5f9',100:'#ffffff',200:'#f1f5f9',300:'#e2e8f0',400:'#cbd5e1',500:'#94a3b8' },
        success: { 50:'#f0fdf4',100:'#dcfce7',400:'#4ade80',500:'#22c55e',600:'#16a34a',700:'#15803d' },
        warning: { 50:'#fff7ed',100:'#ffedd5',400:'#fb923c',500:'#f97316',600:'#ea580c',700:'#c2410c' },
      ...
      animation: {
        'slide-up':'slide-up 0.4s ease-out','slide-in-right':'slide-in-right 0.3s ease-out','fade-in':'fade-in 0.3s ease-out',
        'pop':'pop 0.3s ease-out','shimmer':'shimmer 2s linear infinite','scale-in':'scale-in 0.2s ease-out',
        'bounce-in':'bounce-in 0.6s ease-out','glow':'glow 2s ease-in-out infinite','float':'float 3s ease-in-out infinite',
        'celebrate':'celebrate 0.6s ease-out','ripple':'ripple 1.5s ease-out infinite','spin-slow':'spin-slow 3s linear infinite',
