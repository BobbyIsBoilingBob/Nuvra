    ...
    <div className="pb-24">
      ...
      <div className="px-4 py-4 max-w-lg mx-auto space-y-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <Card className="p-4 flex flex-col items-center gap-1" onClick={() => navigate('friends')}>
            <Users size={24} className="text-brand-400" />
            <span className="text-xs text-ink-200">Friends</span>
          </Card>
          <Card className="p-4 flex flex-col items-center gap-1" onClick={() => navigate('party')}>
            <MessageCircle size={24} className="text-brand-400" />
            <span className="text-xs text-ink-200">Party</span>
          </Card>
          <Card className="p-4 flex flex-col items-center gap-1" onClick={() => navigate('creator')}>
