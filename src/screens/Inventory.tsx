...
export default function Inventory() {
  const { ownedItems, equipped, equipItem, setScreen } = useStore(); const [category, setCategory] = useState<InventoryCategory>('trails');
