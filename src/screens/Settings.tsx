        ...
        <div className="px-4 max-w-md mx-auto flex flex-col gap-4 pt-4">
          <GlassCard className="p-4">
            ...
            <div className="mt-3">
              ...
              <input type="text" value={profile.avatarEmoji} onChange={e => setProfile({ avatarEmoji: e.target.value.slice(0, 2) })} className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2.5 text-white text-2xl text-center outline-none focus:border-zeviqo-400/50" maxLength={2} />
            </div>
          </GlassCard>
