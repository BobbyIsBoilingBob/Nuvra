...
export default function Seasonal() {
  ...
  return (
    <Screen>
      <h1 className="font-display text-2xl font-bold text-white mb-2 flex items-center gap-2"><Calendar size={24} color="#22c55e" /> Seasonal Items</h1>
      <p className="text-ink-400 mb-4 text-sm">Limited edition cosmetics available for a short time!</p>
      <div className="grid grid-cols-2 gap-3">{SEASONAL_ITEMS.map(item => {
