...
export function Shop() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden pb-24">
      ...
      <div className="relative z-10"><TopBar title="Shop" showBack />
            ...
            {SHOP_ITEMS.map(item => {
              ...
              return (
                <GlassCard key={item.id} className={`p-4 flex flex-col items-center gap-2 ${owned ? 'opacity-50' : ''}`}>
                  ...
                  {owned ? <div className="flex items-center gap-1 text-xs font-bold text-zeviqo-300"><Icon name="CheckCircle" size={14} /> Owned</div>
