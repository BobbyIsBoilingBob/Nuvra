        ...
        <div className="px-4 max-w-md mx-auto flex flex-col gap-4">
          <GlassCard className="p-5">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-4xl" style={{ background: profile.avatar.color+'30' }}>{profile.avatar.emoji}</div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button variant="secondary" icon="History" onClick={() => setScreen('history')}>History</Button>
