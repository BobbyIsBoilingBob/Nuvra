...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-ink-950">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {mode === 'signup' && (
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={username} onChange={e => setUsername(e.target.value)} placeholder="3-20 characters" maxLength={20}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowPw(!showPw)} className="absolute right-3 top-1/2 -translate-y-1/2 text-ink-500 hover:text-ink-400">
      ...
      <p className="text-ink-500 text-xs mt-6 flex items-center gap-1"><Compass size={14} /> Start your walking adventure today</p>
    </div>
  );
}
