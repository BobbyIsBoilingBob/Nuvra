...
export default function SignupScreen({ onAuthed, onSwitchToLogin }: Props) {
  ...
  return (
    <div className="min-h-screen bg-ink-950 flex flex-col items-center justify-center px-6 animate-fade-in">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-ink-400 mt-1">Join the adventure</p>
      </div>
      ...
      <p className="text-sm text-ink-500 mt-6">
        ...
        <button onClick={onSwitchToLogin} className="text-brand-400 hover:text-brand-300 transition font-medium">
          Sign in
        </button>
      </p>
    </div>
