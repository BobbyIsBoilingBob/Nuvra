  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-surface-0 via-brand-50/40 to-accent-50/30 flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 max-w-md mx-auto w-full">
        <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-accent-500 to-accent-600 flex items-center justify-center shadow-glow-accent mb-6 animate-bounce-in">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-4 mt-8 animate-slide-up">
          ...
          <div>
            <label className="text-xs font-semibold text-ink-500 mb-1.5 block">Username</label>
            <div className="relative">
              <User size={18} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-ink-400" />
              <input type="text" required value={username} onChange={e => setUsername(e.target.value)}
                placeholder="Your adventurer name" className="input-field pl-11" />
            </div>
          </div>
          <div>
