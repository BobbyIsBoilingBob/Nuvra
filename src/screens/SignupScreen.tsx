...
export default function SignupScreen({ onNavigate, onToast }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false)
    if (error) onToast('error', 'Signup failed', error)
    else onToast('success', 'Account created!', 'Welcome to Zeviqo')
  }
