...
export const mockProfile: UserProfile = { id: 'demo-user', username: 'Explorer', xp: 2450, coins: 320, gems: 15, walking_streak: 7, completed_adventures: 12, avatar_color: '#10b981', level: 5, created_at: new Date().toISOString() }
...
export const mockDailyReward: DailyReward = { id: 'dr1', last_claim_date: new Date(Date.now() - 86400000).toISOString().split('T')[0], streak: 6 }
